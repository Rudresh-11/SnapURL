...
- Framework(s): express nodejs
- Package manager: npm
- Runtime / versions: 
- Database / queues / cache: postgres
...
check for src/utils , it have some classes
...
Some endpoints are already written in src/routes/
Do NOT invent endpoints or contracts unless explicitly said.
...
if project doesnt have one then ignore
